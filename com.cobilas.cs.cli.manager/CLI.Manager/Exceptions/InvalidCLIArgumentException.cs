...
/// <summary>
/// Represents an error that occurs when an invalid CLI argument is encountered.
/// </summary>
[Serializable]
public class InvalidCLIArgumentException : Exception
{
	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIArgumentException"/> class.
	/// </summary>
	public InvalidCLIArgumentException() { }

	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIArgumentException"/> class with a specified error message.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIArgumentException"/> class with serialized data.
	/// </summary>
