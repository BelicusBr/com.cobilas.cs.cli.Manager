...
/// <summary>
/// Represents an error that occurs when a CLI argument has an unexpected type.
/// </summary>
[Serializable]
public class InvalidCLIArgumentTypeException : Exception
{
	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIArgumentTypeException"/> class.
	/// </summary>
	public InvalidCLIArgumentTypeException() { }

	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIArgumentTypeException"/> class with a specified error message.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIArgumentTypeException"/> class with serialized data.
	/// </summary>
