...
/// <summary>
/// Represents an error that occurs when an invalid CLI option is encountered.
/// </summary>
[Serializable]
public class InvalidCLIOptionException : Exception
{
	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIOptionException"/> class.
	/// </summary>
	public InvalidCLIOptionException() { }

	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIOptionException"/> class with a specified error message.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="InvalidCLIOptionException"/> class with serialized data.
	/// </summary>
